        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Blood Chemistry and SGPT</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                    ...
                    <div class="container-fluid">
                        <div class="card mt-1">
                            <div class="card-header">
                                Input Result for Blood Chemistry
                            </div>
                            <div class="card-body">
                                <form id="input-form">
                                    <div class="row">
                            ...
                            <div class="card-body mt-3">
                                <form id="input-form">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5 mt-3">
                                            <input type="text" style="text-align: center;" value="Normal Value" class="form-control" readonly>
                                        </div>
