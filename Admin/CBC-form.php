                                ...
                                <form id="input-form">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 mt-3">
                                            <input type="text" style="text-align: center;" value="Differential count of White Blood Cells" class="form-control" readonly>
                                        </div>
                                        <div class="col-sm-5 mt-3">
                                            <input type="text" style="text-align: center;" value="Test" class="form-control" readonly>
                                        </div>
                                        ...
                                        <div class="col-sm-5 mt-3">
                                            <input type="text" class="form-control" style="text-align: center;" value="Segmenters" readonly>
                                        </div>
                                        <div class="col-sm-2 mt-3">
                                            <input type="text" style="text-align: center;" class="form-control">
                                        </div>
                                        ...
                                        <div class="col-sm-5 mt-3">
                                            <input type="text" style="text-align: center;" value="56.00" class="form-control" readonly>
                                        </div>

                                        <div class="col-sm-5 mt-3">
                                            <input type="text" class="form-control" style="text-align: center;" value="Lymphocytes" readonly>
                                        </div>
                                        <div class="col-sm-2 mt-3">
                                            <input type="text" style="text-align: center;" class="form-control">
                                        </div>
                                        ...
                                        <div class="col-sm-5 mt-3">
                                            <input type="text" style="text-align: center;" value="34.00" class="form-control" readonly>
                                        </div>

                                        <div class="col-sm-5 mt-3">
                                            <input type="text" class="form-control" style="text-align: center;" value="Eosinophils" readonly>
                                        </div>
                                        <div class="col-sm-2 mt-3">
                                            <input type="text" style="text-align: center;" class="form-control">
                                        </div>
                                        ...
                                        <div class="col-sm-5 mt-3">
                                            <input type="text" style="text-align: center;" value="02.70" class="form-control">
                                        </div>
                                        <div class="col-sm-5 mt-3">
                                            <input type="text" class="form-control" style="text-align: center;" value="Monocytes" readonly>
                                        </div>
                                        <div class="col-sm-2 mt-3">
                                            <input type="text" style="text-align: center;" class="form-control">
                                        </div>
                                        ...
                                        <div class="col-sm-5 mt-3">
                                            <input type="text" style="text-align: center;" value="04.00" class="form-control">
                                        </div>
                                        <div class="col-sm-5 mt-3">
                                            <input type="text" class="form-control" style="text-align: center;" value="Basophils" readonly>
                                        </div>
                                        <div class="col-sm-2 mt-3">
                                            <input type="text" style="text-align: center;" class="form-control">
                                        </div>
                                        ...
                                        <div class="col-sm-5 mt-3">
                                            <input type="text" style="text-align: center;" value="00.30" class="form-control">
                                        </div>
                                        <div class="col-sm-5 mt-3">
                                            <input type="text" class="form-control" style="text-align: center;" value="Bands" readonly>
                                        </div>
                                        <div class="col-sm-2 mt-3">
                                            <input type="text" style="text-align: center;" class="form-control">
                                        </div>
                                        ...
                                        <div class="col-sm-5 mt-3">
                                            <input type="text" style="text-align: center;" value="03.00" class="form-control">
                                        </div>
                                       ...
                                       <div class="col-sm-12 mt-3">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <label for="inputText" class="col-sm-2 col-form-label">Pus cells</label>
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control">
                                            </div>
                                            <div class="col-sm-1">
                                        ...
                                        <div class="row mt-3">
                                            <label for="inputText" class="col-sm-2 col-form-label">Renal cells</label>
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control">
                                            </div>
                                            <div class="col-sm-1">
                                        ...
                                        <div class="row mt-3">
                                            <label for="inputText" class="col-sm-2 col-form-label">Uric Acid</label>
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control">
                                            </div>
                                            <div class="col-sm-1">
